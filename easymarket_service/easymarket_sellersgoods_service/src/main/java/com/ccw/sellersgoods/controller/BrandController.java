package com.ccw.sellersgoods.controller;
...
import com.ccw.sellersgoods.service.BrandService;
...
public class BrandController {
     ...
     * @return
     */
    @ApiOperation(value = "Brand条件分页查询",notes = "分页条件查询Brand方法详情",tags = {"BrandController"}) //表示对方法的说明
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "查询下拉列表",notes = "查询所Brand有方法详情",tags = {"BrandController"})
    @GetMapping("/selectOption")
    public ResponseEntity<List<Map>> selectOption(){
        return ResponseEntity.ok(brandService.selectOption());
    }
}
